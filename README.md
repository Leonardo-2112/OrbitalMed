...
```mermaid
flowchart LR
    A[Paciente em comunidade remota] --> B[Agente Comunitário de Saúde]
    B --> C[Triagem guiada na plataforma]
    C --> D[Conexão via satélite]
    D --> E[Médico remoto]
    E --> F[Orientação, prescrição ou encaminhamento]
    F --> G[Registro no histórico da comunidade]
```
...
![Página inicial da OrbitalMed](assets/prints/home.png)

### Página Sobre

![Página Sobre da OrbitalMed](assets/prints/sobre.png)

### Página Solução

![Página Solução da OrbitalMed](assets/prints/solucao.png)

### Simulação de Triagem

![Página de triagem da OrbitalMed](assets/prints/triagem.png)

### FAQ

![Página de perguntas frequentes](assets/prints/faq.png)

### Integrantes

![Página de integrantes](assets/prints/integrantes.png)

### Contato

![Página de contato](assets/prints/contato.png)
